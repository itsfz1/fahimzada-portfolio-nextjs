            ...
            <div id="about" className="aboutme">
                ...
                <div className="right-side">
                    ...
                    <div className="about-icons">
                        <a title="Reading"><AiOutlineRead className="view" style={{ height: "2rem", width: "2rem", color: "#fff" }} /></a>
                        <a title="Cooking"><GiCampCookingPot className="view" style={{ height: "2rem", width: "2rem", color: "#fff" }} /></a>
                        <a title="Music"><BsMusicNoteList className="view" style={{ height: "2rem", width: "2rem", color: "#fff" }} /></a>
                        <a title="Video Games"><CgGames className="view" style={{ height: "2rem", width: "2rem", color: "#fff" }} /></a>
                    </div>
